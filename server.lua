...
--- CONFIG ---
password = "vamessztos" -- Set server password here
kickMessage = "Hasło znajdziesz na discordzie: https://discord.gg/FD7PyeH" -- The invalid password kick message. Default: Invalid Password
timeRanOutMsg = "Za długo zwlekałeś z wpisaniem hasła" --Not active yet! Dont worry about this
timeoutMessage = "Złe hasło. Proszę poczekać %s przed wejściem na wyspę." -- Displayed if the user tries to attempt too many times, this locks them out of the server for x seconds
invalidPasswordTimeout = 5 * 10 -- Wait time before the player can re-join. Change the first value Not the '* 60'. Default: 5 minutes
